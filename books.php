                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="feature-card p-2">
                            ...
                            <img src="assets/images/books/bok2.png" alt="bild på bok n.1" height="430">
                    ...
                    <div class="col-md-6">
                        <div class="feature-card p-2">
                            ...
                            <img src="assets/images/books/bok1.png" alt="bild på bok n.2" height="430">
                    ...
                    <div class="col-md-3">
                        <div class="feature-card p-2">
                            <div class="myDIV">
                                <h4>3:</h4>
                                <img src="assets/images/books/bok3.png" alt="bild på bok n.3" width="200">
                            </div>
                    ...
                    <div class="col-md-3">
                        <div class="feature-card p-3">
                            <div class="myDIV">
                                <h4>4:</h4>
                                <img src="assets/images/books/bok4.png" alt="bild på bok n.4" width="200">
                            </div>
                    ...
                    <div class="col-md-3">
                        <div class="feature-card p-3">
                            <div class="myDIV">
                                <h4>5:</h4>
                                <img src="assets/images/books/bok5.png" alt="bild på bok n.5" width="200">
                            </div>
                    ...
                    <div class="col-md-3">
                        <div class="feature-card p-3">
                            <div class="myDIV">
                                <h4>6:</h4>
                                <img src="assets/images/books/bok6.png" alt="bild på bok n.6" width="200">
                            </div>
                    ...
                    <div class="col-md-3">
                        <div class="feature-card p-3 mb-5">
                            <div class="myDIV">
                                <h4>7:</h4>
                                <img src="assets/images/books/bok7.png" alt="bild på bok n.7" width="200">
                            </div>
                    ...
                    <div class="col-md-3">
                        <div class="feature-card p-3 mb-5">
                            <div class="myDIV">
                                <h4>8:</h4>
                                <img src="assets/images/books/bok8.png" alt="bild på bok n.8" width="200">
                            </div>
                    ...
                    <div class="col-md-3">
                        <div class="feature-card p-3 mb-5">
                            <div class="myDIV">
                                <h4>9:</h4>
                                <img src="assets/images/books/bok9.png" alt="bild på bok n.9" width="200">
                            </div>
                    ...
                    <div class="col-md-3">
                        <div class="feature-card p-3 mb-5">
                            <div class="myDIV">
                                <h4>10:</h4>
                                <img src="assets/images/books/bok10.png" alt="bild på bok n.10" width="200">
                            </div>
        ...
        <section class="container mt-4">
            ...
            <section>
                <div class="d-flex flex-row">
                    <div class="p-2">
                        <a href="recension.php?source=books" class="shadow text-white"><i class="fa-solid fa-plus"></i><u>Skapa recension</u></a>
                    </div>
                </div>
            </section>
