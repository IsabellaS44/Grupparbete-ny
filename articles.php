...
<main>
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="feature-card p-2">
                        ...
                        <img src="assets/images/art1.png" alt="bild på artikel n.1" height="430">
                ...
                <div class="col-md-6">
                    <div class="feature-card p-2">
                        ...
                        <img src="assets/images/art2.png" alt="bild på artikel n.2" height="430">
    ...
    <!-- Topp 3-6 rutorna -->
                ...
                <div class="myDIV">
                        <h4>3:</h4>
                        <img src="assets/images/art3.png" alt="bild på artikel n.3" width="200">
                </div>
                ...
                <div class="myDIV">
                        <h4>4:</h4>
                        <img src="assets/images/art4.png" alt="bild på artikel n.4" width="200">
                </div>
                ...
                <div class="myDIV">
                        <h4>5:</h4>
                        <img src="assets/images/art5.png" alt="bild på artikel n.5" width="200" >
                </div>
                ...
                <div class="myDIV">
                        <h4>6:</h4>
                        <img src="assets/images/art6.png" alt="bild på artikel n.6" width="200">
                </div>
...
<!-- Testimonial section-->
    ...
    <!-- Recension -->
            <div class="row g-4">
                    <div class="card-b mb-3">
                        <i class="fa-solid fa-circle-user fa-xl"></i><p class="fw-bold mb-0">Emma Lundqvist</p>
                            <div class="text-warning">
                            <i class="fa-solid fa-star"></i>
                            <i class="fa-solid fa-star"></i>
                            <i class="fa-solid fa-star"></i>
    ...
    <section>
        <div class="container">
            <div class="row g-4">
                    <div class="card-b mb-3">
                        <i class="fa-solid fa-circle-user fa-xl"></i><p class="fw-bold mb-0">Johan Bergström</p>
    ...
    <section>
            ...
            <div class="row g-4">
                    <div class="card-b mb-3">
                    <i class="fa-solid fa-circle-user fa-xl"></i><p class="fw-bold mb-0">Sara Nilsson</p>
